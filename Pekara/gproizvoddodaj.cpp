...
#include "ui_gproizvoddodaj.h"
#include <konekcija.h>
#include <QMessageBox>
#include <QDateTime>

gProizvodDodaj::gProizvodDodaj(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::gProizvodDodaj)
{
    ui->setupUi(this);
...
gProizvodDodaj::~gProizvodDodaj()
{
    delete ui;
}

void gProizvodDodaj::on_izlazDugme_clicked()
{
    this -> close();
}

void gProizvodDodaj::on_dodajDugme_clicked()
{
    Konekcija baza;
    baza.dbOpen();
    ...
    else
    {
        ...
        else
        {
            ...
            upit.prepare("INSERT INTO gotoviProizvodi(Naziv, Jed_Mere, Kolicina, Cena) VALUES(:Naziv, :JedinicaMere, :Kolicina, :NabavnaCena)");
            ...
            Datum = datum + " " + vreme;
            Opis = "Dodat finalni proizvod " + Naziv + ", dodata količina " + kol + " " + JedinicaMere.toLower() + ", po ceni od " + NC + " dinara. ";
