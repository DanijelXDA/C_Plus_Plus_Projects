...
#include "ui_gproizvodazuriraj.h"
#include "konekcija.h"
#include <QMessageBox>
#include <QDateTime>

gProizvodAzuriraj::gProizvodAzuriraj(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::gProizvodAzuriraj)
{
    ui->setupUi(this);
...
gProizvodAzuriraj::~gProizvodAzuriraj()
{
    delete ui;
}

void gProizvodAzuriraj::on_dugmeIzlazAz_clicked()
{
    this -> close();
}


void gProizvodAzuriraj::on_dugmeUcitajAz_clicked()
{
    Konekcija baza;
...
void gProizvodAzuriraj::on_comboBoxID_currentIndexChanged()
{
    Konekcija baza;
...
void gProizvodAzuriraj::on_azurirajDugme_clicked()
{
    Konekcija baza;
    baza.dbOpen();
    ...
    else
    {
        ...
        else
        {
            ...
            upit.prepare("UPDATE gotoviProizvodi SET Naziv = :Naziv, Kolicina = :Kolicina, Jed_Mere = :JedinicaMere, Cena = :Cena WHERE Sifra = :Indeks");
            ...
            Datum = datum + " " + vreme;
            Opis = "Ažuriran finalni proizvod " + Naziv + ", dodata količina " + kol + " " + JedinicaMere.toLower() + ", po ceni od " + Cena + " dinara. ";
